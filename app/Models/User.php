 ...
 * @property UserStatusEnum $status 0 - inactive, 1 - active, 2 - rejected
 ...
 * @method \Illuminate\Database\Eloquent\Builder|\App\Models\User permission(string|array $permissions)
 * @method bool hasPermissionTo(string|array $permission, string|null $guard = null)
 * @method \Illuminate\Database\Eloquent\Builder|\App\Models\User doesNotHaveRole(string|array $roles)
 * @method \Illuminate\Database\Eloquent\Builder|\App\Models\User doesNotHavePermissionTo(string|array $permissions)
 * @mixin \Eloquent
 */
