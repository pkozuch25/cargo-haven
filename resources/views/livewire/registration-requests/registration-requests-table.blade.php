<div class="space-y-4">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full table-auto">
            ...
            {{-- Table Body --}}
            <tbody>
                <div class="absolute inset-0 flex justify-center items-center" wire:loading>
                    <div class="spinner-border" role="status" aria-hidden="true"></div>
                </div>
                @forelse($this->queryRefresh() as $request)
                    <tr>
                        <td class="px-4 py-2 border-t border-gray-300 dark:border-gray-700">{{ $request->email }}</td>
                        <td class="px-4 py-2 border-t border-gray-300 dark:border-gray-700">{{ $request->name }}</td>
                        <td class="px-4 py-2 border-t border-gray-300 dark:border-gray-700">{{ $request->created_at }}</td>
